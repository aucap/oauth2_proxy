...
Assuming cookie domain is set to `.example.com`, the requests `test.example.com`, `other.example.com` and  `other.example.com/path/` will all be routed to different upstreams.
